...
if { $list_projs eq "" } {
   create_project zcu111_base zcu111_base -part xczu7ev-ffvc1156-2-e
   set_property BOARD_PART xilinx.com:zcu111:part0:2.5 [current_project]
}
...
set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  set_property PFM_NAME {xilinx:zcu111:zcu111_base:1.0} [get_files [current_bd_design].bd]
...
generate_target  all  [get_files  ./zcu111_base/zcu111_base.srcs/sources_1/bd/zcu111_base/zcu111_base.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu111_base/zcu111_base.srcs/sources_1/bd/zcu111_base/zcu111_base.bd] -top
add_files -norecurse ./zcu111_base/zcu111_base.srcs/sources_1/bd/zcu111_base/hdl/zcu111_base_wrapper.v
...
file mkdir ./zcu111_base/zcu111_base.sdk
write_hwdef -force  -file ./zcu111_base/zcu111_base.sdk/zcu111_base_wrapper.hdf

#set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./xilinx_zcu111_base_202010_1.xsa
#write_hw_platform -force  ././xilinx_zcu111_base_202010_1.xsa

validate_hw_platform ./xilinx_zcu111_base_202010_1.xsa
